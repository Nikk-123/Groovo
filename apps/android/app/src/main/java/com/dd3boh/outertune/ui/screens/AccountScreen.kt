...
fun AccountScreen(
    ...
    val isLoggedIn = remember(innerTubeCookie, accountEmail) {
        "SAPISID" in parseCookieString(innerTubeCookie) || accountEmail.isNotEmpty()
    }
    ...
    LazyVerticalGrid(
        ...
        stickyHeader {
            Column {
                val (_, onAccountEmailChange) = rememberPreference(AccountEmailKey, "")
                if (accountEmail.isNotEmpty()) {
                    ...
                    PreferenceEntry(
                        ...
                        onClick = {
                            onAccountEmailChange("") // Clear session
    ...
    TopAppBar(
        title = {
            Row(
                ...
                Text(
                    text = if (isLoggedIn && accountName == stringResource(R.string.not_logged_in)) accountEmail else accountName,
