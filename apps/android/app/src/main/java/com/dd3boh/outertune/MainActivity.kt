                        ...
                        Box(
                            ...
                            val navHost: @Composable() (() -> Unit) = @Composable {
                                NavHost(
                                    ...
                                    startDestination = if (rememberPreference(AccountEmailKey, "").value.isNotEmpty()) {
                                        (Screens.getAllScreens().find { it.route == defaultOpenTab })?.route ?: Screens.Home.route
                                    } else {
                                        "login"
                                    },
                                    enterTransition = {
...
//                                                } == true
                            ...
                            if (oobeStatus >= OOBE_VERSION && currentRoute != "login") {
                                BottomSheetPlayer(
